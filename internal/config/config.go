...
type Config struct {
	AveVisitorID                                                                                                       string
	Env, Port, DatabaseURL, RedisURL, RPCURL, RPCSendURL, RPCWSURL, ChainName, AveBaseURL, AveXAuth                    string
	ChainID                                                                                                            int64
